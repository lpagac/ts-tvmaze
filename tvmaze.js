...
var BASE_TV_API_URL = "http://api.tvmaze.com";
var DEFAULT_IMAGE_URL = "http://joelburton.com/joel-burton.jpg";
...
function getShowsByTerm(term) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get(BASE_TV_API_URL + "/search/shows?q=" + term)];
                case 1:
                    showsResult = _a.sent();
                    return [2 /*return*/, showsResult.data.map(function (s) {
                            return {
                                id: s.show.id,
                                name: s.show.name,
